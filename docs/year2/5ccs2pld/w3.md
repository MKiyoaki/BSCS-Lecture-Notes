...
- We will define an abstract machine with
  ...
  3. **memory**, also called **store**, modelled by a partial function $m$, mapping each address to an integer. $dom(m)$ denotes the locations where $m$​ is defined.
...
- Example
  ...
  >- $⟨(E_1\ bop\ E_2)·c, r, m⟩ \rightarrow ⟨E_1 · E_2 · bop ·c, r, m⟩$
  >- $⟨op·c,b·r,m⟩ \to ⟨c,n·r,m⟩ \text{ if } n_1 \text{ op } n_2 = n$​
  >- $⟨bop·c,b·r,m⟩ \to ⟨c,b·r,m⟩ \text{ if } n_1 \text{ bop } n_2 = b$​
  ...
  >>>
  >  $⟨!l>0·\text{nil,nil},m⟩ \to ⟨!l·0·>·\text{nil,nil},m⟩ $
  >>>
  >  $\to ⟨0·>·\text{nil},4·\text{nil},m⟩$ 
  >>>
  >  $\to ⟨>·\text{nil},0·4·\text{nil},m⟩$ 
  >>>
  >  $ \to ⟨\text{nil,True·nil},m⟩$
  >
