...
- (Deterministic) Polynomial time - $P$
  ...
  $P = \{\text{all problems decidable in polynomial time}\}$
...
- Non-deterministic Polynomial time - $NP$
  ...
  $NP = \{\text{all problems decidable in non-deterministic polynomial time}\}$
...
>
> $P$ are the questions that **can be solved** in polynomial time, and $NP$ are the questions that **their answers can be vertified** in polynomial time. 
>
> $NP$ includes $P$. 
