...
>⏹️
>
>[➡️ WEEK II - ](year2/5ccs2pld/w2.md)
>
>Outlines:
>
...
> A programming language may enforce a particular style of programming: a programming paradigm.
...
- Definition
  - The **compiler** translates the source language into machine language that can be executed directly on the computer.
...
- Terminology
  - `syntax` 
    ...
    - Two types
      1. `Concrete Syntax` - describes which chains of characters are well-formed programs.
      2. `Abstract Syntax ` - describes the syntax trees, to which a semantics is associated.
  - `grammar` - The concept that we used to specify a language
...
- Terminology
  ...
  - `semantics` 
    ...
    - A language defines the meaning of programs
