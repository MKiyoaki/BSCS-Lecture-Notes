...
- Background
  ...
  > AI Planning provides hybrid of graph search approach and constraints of CSPs. Defining problems in a language that allows us to encapsulate the world facts and behaviour. 
...
- PDDL Planning Model
  ...
  - Described through two files
    ...
    1. Domain file
       ...
       > General description of the world. Which types of objects are involved, What actions can be applied, etc ...

    2. Problem file(s)

       >Specific situation you want to solve. List of objects, initial state, goal state.
...
- Fluent
  ...
  - PDDL 2.1 introduces the ability to model numeric values through **fluents**.

  - We can identify a particular resource within the domain by having action effects increase or decrease the value of that resource, which more accurately helps maintain an understanding of the costs of actions.
...
- Planning
  ...
  - Domain-Independent Planning
    - Domain-independent heuristics is the method that defining heuristics for PDDL domain
