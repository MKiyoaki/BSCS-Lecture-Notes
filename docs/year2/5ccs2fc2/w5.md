...
>   1. Pure Literal Elimination - elminate the literals with only postive or negative prefix
>
>    2. Unit Propagation - eliminate unit literals and clauses with these unit literals
>   3. DPLL - PLE, UP and then backtrack algorithm
> 
>
