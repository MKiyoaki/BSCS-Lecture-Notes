...
>   - Host, Router
>   - IP, IP addresses, IP messages
>   - MAC address, IPv4, IPv6 *Calculating questions
>   - IP messages/datagrams: Header + Data
> - Board structure of messaging and key aims of IP protocol
> - Route IP messages via simple routing strategies
>   - Fragement & Reassembly  *Calculating questions
>   - IP Routing  *Calculating questions
...
[![Internet Protocol version 4 - Wikipedia](https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/IPv4_Packet-en.svg/1200px-IPv4_Packet-en.svg.png)](https://www.google.com/url?sa=i&url=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FInternet_Protocol_version_4&psig=AOvVaw2vnr9ID41Cvvr8HwAO5pYZ&ust=1696072413262000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCMiFzKDYz4EDFQAAAAAdAAAAABAE)
...
- [Security](https://tools.ietf.org/html/rfc4301)
  ...
  - There is no security in the original IP since packet header and contents are visible. 
  - IPSec mandatory feature of IPv6. 
  - IPSec is often used to for Virtual Private Networks (VPNs)

- Reliability

  - Message Delivery
    - Unreliable (no guarantee about message delivery)
