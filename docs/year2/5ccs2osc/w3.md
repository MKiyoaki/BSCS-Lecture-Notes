...
>
>[➡️ WEEK IV - Explicit locks, deadlock, semaphores](year2/5ccs2osc/w4.md)
>
>Outlines:
>
>- Synochronization
...
- Structure
  ...
  - Cache
    ...
    - The number of caches depends on the model. However, there will usually be one to four levels of cache in a CPU. These caches are used to store frequently accessed data and instructions close to the CPU so that it can access them very quickly.
