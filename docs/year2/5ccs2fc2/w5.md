...
>ref: 
>
>[Conflict Driven Clause Learning - Zhihu](https://zhuanlan.zhihu.com/p/92659252)
...
​	$\enclose{horizontalstrike}{(P \vee Q \vee \neg S)}, \enclose{horizontalstrike}{(P \vee \neg Q)}, (Q \vee R), \enclose{horizontalstrike}{(Q \vee \neg R \vee \neg S)}$
...
​	$\enclose{horizontalstrike}{\neg Q}, (P \vee Q), (\neg P \vee \neg R \vee S), (\neg P \vee Q \vee \neg S), \enclose{horizontalstrike}{(\neg P \vee \neg Q)}, \enclose{horizontalstrike}{R}, \enclose{horizontalstrike}{(Q \vee R \vee S)}$
