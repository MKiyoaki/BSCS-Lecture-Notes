...
2. Network Layer - Enable data to traverse any kind of network
...
2. Host/Domain names for human consumption
...
2. Exploitation to the key messages
  - PING 
    - PING Utility
...
1. [Security](https://tools.ietf.org/html/rfc4301)
