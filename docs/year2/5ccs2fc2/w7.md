...
- **Steps**
  ...
  5. The **pivot value** is the value in the pivot column and in the pivot row. Apply the following row transformation: 
     ...
     *All non-pivot rows* - $R_i \leftarrow R_i - (\frac{\text{current } R_i \text{ value}}{\text{current pivot value}}) \times R_{\text{pivot}}$
     ...
     >$ \begin{bmatrix} 3 &2 &1 &0 &0 &0 &15 \\ \bold{-1} &\underline{\textbf{2}} &\textbf{0} &\textbf{1} &\textbf{0} &\textbf{0} &\textbf{5} \\ 1 &2 &0 &0 &1 &0 &7 \\ -2 &-3 &0 &0 &0 &1 &0 \end{bmatrix} \implies \begin{bmatrix} 4 &0 &1 &-1 &0 &0 &10 \\ -0.5 &1 &0 &0.5 &0 &0 &2.5 \\ 2 &0 &0 &-1 &1 &0 &2 \\ -3.5 &0 &0 &1.5 &0 &1 &7.5 \end{bmatrix}$ 
     >
